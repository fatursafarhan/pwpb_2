		...
		<div class="rounded shadow p-5 bg-white">
			<div class="row">
				...
				<div class="col-md-4 mb-4 mb-md-0 text-center">
					...
					<h3 class="mt-4 text-capitalize h5 ">keep smiling when looking for errors</h3>
				</div>
				<div class="col-md-4 mb-4 mb-md-0 text-center">
					<i class="ti-thought text-primary h1"></i>
					<h3 class="mt-4 text-capitalize h5 ">creative</h3>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="images/computer.png" alt="iphone">
				</div>
			</div>
			<div class="col-lg-6 mr-auto align-self-center">
				<div class="feature-content">
					...
					<!-- Feature Description -->
					<p class="desc">Pemrograman adalah proses menulis, menguji dan memperbaiki (debug), dan memelihara kode yang membangun sebuah program komputer.
						 Kode ini ditulis dalam berbagai bahasa pemrograman. Tujuan dari pemrograman adalah untuk memuat suatu program yang dapat melakukan suatu 
						 perhitungan atau 'pekerjaan' sesuai dengan keinginan si pemrogram (programmer).
						  Untuk dapat melakukan pemrograman, diperlukan keterampilan dalam algoritma, logika, bahasa pemrograman, dan di banyak kasus, pengetahuan-pengetahuan lain seperti matematika.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto align-self-center">
				<div class="feature-content">
					...
					<h2>Apa itu PHP?</h2>
					<!-- Feature Description -->
					<p>PHP adalah singkatan dari PHP : Hypertext Preprocessor. Di mana huruf ‘P’ pada kata PHP merupakan singkatan dari kata PHP itu sendiri atau yang sering disebut rekursif.
							...
							PHP merupakan bahasa pemrograman paling populer yang digunakan dalam membuat sebuah website. Berdasarkan survei dari Wtechs, bahasa pemrograman PHP merupakan bahasa pemrograman server-side yang paling populer dibandingkan ASP.NET maupun dengan Java.</p>
				</div>
			</div>
			<div class="col-lg-6 mr-auto justify-content-center">
				<!-- Feature mockup -->
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="images/coding.png" alt="ipad">
				</div>
			</div>
		</div>
	</div>
